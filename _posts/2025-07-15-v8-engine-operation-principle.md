...
다음 글에서는 이러한 V8 구조를 기반으로 한 1-day 취약점인 CVE-2023-2033를 중심으로, TurboFan JIT 최적화 과정에서 발생한 보안 취약점의 원인과 공격 벡터에 대해 분석해보고자 합니다.
